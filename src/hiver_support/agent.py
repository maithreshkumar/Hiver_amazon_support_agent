    ...
    def handle(self, message: str) -> dict[str, object]:
        ...
        try:
            ...
            return {
                ...
                "reply": (
                    "I'm sorry this needs further investigation. Please contact Amazon through a "
                    "secure support channel, and do not post order, address, account, or payment "
                    "details publicly."
                ),
                "decision": "ESCALATE",
                "reason": "The configured local model provider is unavailable, so automated handling is unsafe.",
                "evidence": [],
                "provenance": {
                    "provider": provider,
                    "model": model,
        ...
        return {
            ...
            "provenance": {
                ...
                "routing_policy_version": self.policy.version,
                "safety_override_applied": generated.safety_override_applied,
                "timestamp": datetime.now(UTC).isoformat(),
            },
        }
